const es = {
  ...
  kanbanText: {
    ...
    taskOptionsAriaLabel: "Opciones de la tarea",
    taskMoveButton: "Mover a",
    taskMoveToColumnAriaLabel: "Mover a la columna {{colTitle}}",
    columnOptionsAriaLabel: "Opciones de la columna {{colTitle}}",
