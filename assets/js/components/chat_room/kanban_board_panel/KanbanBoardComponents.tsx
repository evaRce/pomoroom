  ...
  return (
    <>
          ...
          {isEditing ? (
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <Button
                  size="sm"
                  className="h-7 text-xs bg-sky-300 text-slate-800 hover:bg-sky-400"
                  onPointerDown={(e) => e.preventDefault()}
                  onClick={submitRename}
                >
                  {KANBAN_TEXT.task.saveButton}
                </Button>
                <Button
                  variant="ghost"
                  size="sm"
      ...
      <KanbanDialog
        ...
        content={
          <>
            <p className="mt-2 text-base mb-0">
              {KANBAN_TEXT.task.delete.confirmMessage}
            </p>
            <p className="mt-2 text-sm text-rose-500 my-0">
              {KANBAN_TEXT.task.delete.irreversibleWarning}
            </p>
          </>
        }
    ...
    <>
      ...
      <KanbanDialog
        ...
        content={
          <>
            <p className="mt-2 text-base mb-0">
              {KANBAN_TEXT.column.delete.confirmMessage(column.title, hasTasks)}
            </p>
            <p className="mt-2 text-sm text-rose-500 my-0">
              {KANBAN_TEXT.column.delete.irreversibleWarning(hasTasks)}
            </p>
          </>
        }
